...
> Generado 09/09/2026 13:21 WEST · **586 modelos únicos** · **956 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **181 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 280 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
- **glm-5.3-flash:batch** vía **OpenRouter** — **-50.0%** (ahora \$0.0750 in / \$0.2500 out)
- **deepseek-v4-pro-0813:batch** vía **OpenRouter** — **-50.0%** (ahora \$0.6600 in / \$1.9800 out)
- **muse-glimmer-30b:batch** vía **OpenRouter** — **-50.0%** (ahora \$0.1750 in / \$0.7500 out)
...
- **deepseek-v4-flash-0731:batch** vía **OpenRouter** — **-21.4%** (ahora \$0.1100 in / \$0.3300 out)
- **muse-spark-1.2** vía **CheaperInference** — **-17.6%** (ahora \$0.8750 in / \$2.9750 out)
- **kimi** vía **OpenRouter** — **-14.3%** (ahora \$2.4000 in / \$12.0000 out)

### Subidas

- **qwen3-235b-a22b-2507** vía **OpenRouter** — +144.4% (ahora \$0.2200 in / \$0.8800 out)
- **glm-5.3** vía **CheaperInference** — +100.0% (ahora \$0.7700 in / \$2.4200 out)
- **glm-5.3-flash** vía **Novita AI** — +100.0% (ahora \$0.1500 in / \$0.5000 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Alibaba** — +100.0% (ahora \$0.3520 in / \$1.0560 out)
- **glm-5.3-flash** vía **OpenRouter → Novita (novita/fp8)** — +76.0% (ahora \$0.1320 in / \$0.4400 out)
- **granite-4.2-8b** vía **OpenRouter** — +66.7% (ahora \$0.0600 in / \$0.2500 out)
- **glm-5.3-flash** vía **OpenRouter → Relace (relace/fp4)** — +26.3% (ahora \$0.0900 in / \$0.3000 out)

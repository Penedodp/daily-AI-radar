...
> Generado 19/09/2026 12:56 WEST · **599 modelos únicos** · **990 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **198 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 241 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
- **deepseek-v4-pro** vía **OpenRouter** — **-71.7%** (ahora \$0.4527 in / \$0.9055 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-54.7%** (ahora \$0.0400 in / \$0.0800 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-50.4%** (ahora \$0.0440 in / \$0.0879 out)
- **deepseek-v4-flash** vía **CheaperInference** — **-49.8%** (ahora \$0.0359 in / \$0.0717 out)
- **deepseek-v4-pro** vía **CheaperInference** — **-45.0%** (ahora \$0.3810 in / \$0.7621 out)
- **glm-5.3** vía **OpenRouter → Baidu (baidu/fp8)** — **-36.3%** (ahora \$0.8918 in / \$2.8028 out)
- **glm-5.3** vía **OpenRouter** — **-35.0%** (ahora \$0.9100 in / \$2.8600 out)
- **deepseek-v4-flash-0731** vía **OpenRouter** — **-33.3%** (ahora \$0.0400 in / \$0.0800 out)
- **qwen3.8-27b** vía **OpenRouter → Darkbloom (darkbloom/fp4)** — **-33.3%** (ahora \$0.1000 in / \$1.8000 out)
...
- **kimi-k3** vía **OpenRouter** — **-22.4%** (ahora \$1.7000 in / \$8.5000 out)

### Subidas

- **qwen3.8-27b** vía **CheaperInference** — +98.6% (ahora \$0.2975 in / \$1.7850 out)
- **qwen3-vl-30b-a3b-instruct** vía **OpenRouter** — +53.8% (ahora \$0.2000 in / \$0.7000 out)
- **muse-glimmer-30b** vía **OpenRouter** — +36.4% (ahora \$0.3500 in / \$1.5000 out)
- **hy3** vía **OpenRouter → DeepInfra (deepinfra/fp4)** — +33.3% (ahora \$0.1400 in / \$0.5800 out)

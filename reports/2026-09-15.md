...
> Generado 15/09/2026 13:42 WEST · **598 modelos únicos** · **1023 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **235 endpoints de 35 modelos OpenRouter monitorizados** · **73 modelos con benchmark**.
...
_Cobertura de benchmark: 73 modelos con benchmark propio, 249 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
- **qwen3.5-35b-a3b** vía **OpenRouter** — **-48.0%** (ahora \$0.1625 in / \$1.3000 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Phala** — **-30.0%** (ahora \$0.3080 in / \$0.9240 out)
- **glm-5.3** vía **OpenRouter → DeepInfra (deepinfra/fp4)** — **-25.0%** (ahora \$0.9000 in / \$3.0000 out)
- **glm-5.3** vía **OpenRouter → Wafer** — **-20.2%** (ahora \$0.9500 in / \$4.4000 out)
- **glm-5.3** vía **OpenRouter → SiliconFlow (siliconflow/fp8)** — **-20.0%** (ahora \$1.1200 in / \$3.5200 out)
- **glm-5.3** vía **OpenRouter → Phala** — **-18.8%** (ahora \$0.9100 in / \$2.8600 out)
- **qwen3.8-27b** vía **OpenRouter → Phala** — **-15.0%** (ahora \$0.2040 in / \$2.1250 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Inceptron (inceptron/fp4)** — **-14.2%** (ahora \$0.0549 in / \$0.1734 out)

### Subidas

- **glm-5.2** vía **OpenRouter** — +104.9% (ahora \$1.4000 in / \$4.4000 out)
- **glm-5.3-flash** vía **OpenRouter → NextBit (nextbit/fp8)** — +52.5% (ahora \$0.2100 in / \$0.9000 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → DigitalOcean** — +48.8% (ahora \$0.1190 in / \$0.2380 out)
- **glm-5.3** vía **OpenRouter → DigitalOcean** — +32.6% (ahora \$1.2600 in / \$3.9600 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Morph (morph/bf16)** — +15.0% (ahora \$0.1420 in / \$0.3996 out)
- **glm-5.3** vía **OpenRouter → AkashML (akashml/fp8)** — +11.1% (ahora \$1.3000 in / \$4.4000 out)

...
> Generado 11/09/2026 13:13 WEST · **593 modelos únicos** · **951 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **165 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
- **hy3** vía **OpenRouter → DeepInfra (deepinfra/fp8)** — **-50.0%** (ahora \$0.0700 in / \$0.2900 out)
- **gemma-4-26b-a4b-it** vía **OpenRouter** — **-40.0%** (ahora \$0.0420 in / \$0.2200 out)
- **deepseek-v4-pro-0813** vía **OpenRouter** — **-37.1%** (ahora \$0.6600 in / \$1.9800 out)
- **kimi-k3** vía **OpenRouter** — **-22.0%** (ahora \$2.3400 in / \$11.7000 out)
- **glm-5.3-flash** vía **OpenRouter → StreamLake (streamlake/fp8)** — **-16.8%** (ahora \$0.1124 in / \$0.3745 out)
- **deepseek-chat-v3-0324** vía **OpenRouter** — **-13.8%** (ahora \$0.2500 in / \$1.0000 out)
- **gpt-5.4-nano** vía **CheaperInference** — **-13.1%** (ahora \$0.1400 in / \$0.8750 out)
- **kimi-k3** vía **CheaperInference** — **-10.2%** (ahora \$1.8853 in / \$9.4265 out)

### Subidas

- **solar-pro4** vía **OpenRouter** — +200.0% (ahora \$0.0900 in / \$0.3600 out)
- **glm-5.3-flash** vía **OpenRouter → Modal (modal/fp8)** — +200.0% (ahora \$0.4500 in / \$1.5000 out)
- **solar-pro4** vía **OpenRouter → Upstage (upstage/zdr)** — +200.0% (ahora \$0.0900 in / \$0.3600 out)
- **solar-pro4** vía **OpenRouter → Upstage** — +200.0% (ahora \$0.0900 in / \$0.3600 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Sail Research (sail-research/fp4)** — +66.7% (ahora \$0.0650 in / \$0.3000 out)
- **muse-spark-1.2** vía **CheaperInference** — +21.4% (ahora \$1.0625 in / \$3.6125 out)
- **gemini-2.5-flash** vía **CheaperInference** — +15.1% (ahora \$0.2417 in / \$2.0142 out)

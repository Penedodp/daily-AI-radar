...
> Generado 13/09/2026 13:44 WEST · **598 modelos únicos** · **1001 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **212 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 258 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
4. **gemini-2.5-pro-preview-05-06** vía **OpenRouter** — calidad 7.7/10 · coste/tarea $0.09750 (\$1.2500 in / \$10.0000 out) · Radar Value 44.8
5. **deepseek-r1** vía **OpenRouter** — calidad 5.7/10 · coste/tarea $0.03600 (\$0.7000 in / \$2.5000 out) · Radar Value 43.5
...
3. **hy3** vía **OpenRouter → DeepInfra (deepinfra/fp8)** — calidad 7.0/10 · coste/tarea $0.00384 (\$0.0700 in / \$0.2900 out) · Radar Value 67.5
...
- **deepseek-v4-flash-0731** vía **OpenRouter → Baidu (baidu/fp8)** — **-92.0%** (ahora \$0.0352 in / \$0.1056 out)
- **qwen3.8-27b** vía **CheaperInference** — **-49.0%** (ahora \$0.1498 in / \$1.7850 out)
- **qwen3-30b-a3b-instruct-2507** vía **OpenRouter** — **-46.5%** (ahora \$0.0481 in / \$0.1930 out)
- **llama-3.1-70b-instruct** vía **OpenRouter** — **-44.4%** (ahora \$0.4000 in / \$0.4000 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-26.6%** (ahora \$0.0490 in / \$0.0980 out)
- **deepseek-v4-flash** vía **CheaperInference** — **-26.2%** (ahora \$0.0397 in / \$0.0794 out)
- **glm-5.3** vía **OpenRouter** — **-22.0%** (ahora \$1.0920 in / \$3.4320 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Inceptron (inceptron/fp4)** — **-13.4%** (ahora \$0.0619 in / \$0.1374 out)
- **claude-haiku-4.5** vía **CheaperInference** — **-13.1%** (ahora \$0.7000 in / \$3.5000 out)
- **gpt-5.4-nano** vía **CheaperInference** — **-13.1%** (ahora \$0.1400 in / \$0.8750 out)
- **glm-5.3-flash** vía **OpenRouter → Reka (reka/fp8)** — **-12.0%** (ahora \$0.1320 in / \$0.4400 out)

### Subidas

- **gemma-4-26b-a4b-it** vía **OpenRouter** — +114.3% (ahora \$0.0900 in / \$0.3000 out)
- **deepseek-v4-pro** vía **OpenRouter** — +102.8% (ahora \$1.6000 in / \$3.2000 out)
...
- **deepseek-v4-flash** vía **OpenRouter** — +50.9% (ahora \$0.0352 in / \$0.1056 out)
- **muse-glimmer-30b** vía **OpenRouter** — +36.4% (ahora \$0.3500 in / \$1.5000 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → OpenInference (open-inference/fp8)** — +33.3% (ahora \$0.0400 in / \$0.0700 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Sail Research (sail-research/fp4)** — +20.0% (ahora \$0.0780 in / \$0.3600 out)

...
> Generado 22/09/2026 13:38 WEST · **595 modelos únicos** · **983 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **192 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 245 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
| 💻 Coding | LMArena WebDev Arena | **glm-5.3-flash** | **OpenRouter → GMICloud (gmicloud/fp8)** | $0.00375 | $0.0750 | $0.2500 | 8.2/10 | 79.1 |
...
1. **glm-5.3-flash** vía **OpenRouter → GMICloud (gmicloud/fp8)** — calidad 8.2/10 · coste/tarea $0.00375 (\$0.0750 in / \$0.2500 out) · Radar Value 79.1
...
- **qwen3.8-27b** vía **OpenRouter → Reka (reka/fp8)** — **-40.6%** (ahora \$0.1188 in / \$2.4750 out)
- **qwen3.8-flash** vía **Together AI** — **-40.0%** (ahora \$0.0900 in / \$0.2820 out)
- **qwen3.7-max** vía **Together AI** — **-40.0%** (ahora \$1.5000 in / \$4.5000 out)
- **qwen3.8-27b** vía **OpenRouter → Wafer** — **-40.0%** (ahora \$0.1200 in / \$2.5000 out)
- **qwen3.8-27b** vía **OpenRouter → DekaLLM** — **-40.0%** (ahora \$0.1200 in / \$2.5000 out)
- **glm-5.3-flash** vía **OpenRouter → OpenInference (open-inference/fp4)** — **-33.3%** (ahora \$0.1000 in / \$0.5000 out)
- **kimi-k3** vía **OpenRouter → InferenceNet (inference-net/fp4)** — **-31.5%** (ahora \$1.5000 in / \$7.5000 out)
- **deepseek-v4-pro-0813** vía **OpenRouter → Wafer** — **-28.6%** (ahora \$0.7000 in / \$2.9000 out)
- **grok** vía **OpenRouter** — **-20.0%** (ahora \$1.6000 in / \$4.8000 out)
- **llama-4-maverick** vía **OpenRouter** — **-18.4%** (ahora \$0.1875 in / \$0.6525 out)
- **qwen3.8-27b** vía **OpenRouter → Io Net (io-net/fp8)** — **-16.8%** (ahora \$0.2370 in / \$2.2120 out)
- **nemotron-3-nano-30b-a3b** vía **OpenRouter** — **-16.7%** (ahora \$0.0500 in / \$0.2000 out)

### Subidas

- **deepseek-v4-flash** vía **OpenRouter** — +525.0% (ahora \$0.0300 in / \$1.0000 out)
- **deepseek-v4-flash-0731** vía **OpenRouter** — +300.0% (ahora \$0.0400 in / \$0.6400 out)
- **qwen3.8-27b** vía **OpenRouter** — +110.0% (ahora \$0.4200 in / \$3.0000 out)
- **deepseek-v4-pro-0813** vía **OpenRouter → Alibaba** — +93.2% (ahora \$1.1220 in / \$3.3660 out)
- **kimi-k3** vía **OpenRouter** — +76.5% (ahora \$3.0000 in / \$15.0000 out)
- **granite-4.2-8b** vía **OpenRouter** — +66.7% (ahora \$0.0600 in / \$0.2500 out)
- **glm-5.3-flash** vía **OpenRouter** — +66.7% (ahora \$0.1500 in / \$0.5000 out)
- **deepseek-pro** vía **OpenRouter** — +65.3% (ahora \$0.6240 in / \$2.8800 out)

...
> Generado 12/09/2026 12:37 WEST · **598 modelos únicos** · **995 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **205 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 265 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
| **gemma-4-26b-a4b-it** | **OpenRouter** | $0.00282 | $0.0420 | $0.2200 | Novita AI ($0.00686) | **58.9%** |
...
- **qwen3-235b-a22b-2507** vía **OpenRouter** — **-60.2%** (ahora \$0.0875 in / \$0.3500 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-56.2%** (ahora \$0.0300 in / \$0.0700 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → OpenInference (open-inference/fp8)** — **-56.2%** (ahora \$0.0300 in / \$0.0700 out)
- **deepseek-v4-flash-0731** vía **OpenRouter** — **-55.6%** (ahora \$0.0400 in / \$0.0800 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Relace (relace/fp4)** — **-55.6%** (ahora \$0.0400 in / \$0.0800 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Inceptron (inceptron/fp4)** — **-52.0%** (ahora \$0.0681 in / \$0.1587 out)
- **glm-5.3-flash** vía **OpenRouter** — **-50.0%** (ahora \$0.0750 in / \$0.2500 out)
- **qwen3.8-27b** vía **OpenRouter** — **-49.0%** (ahora \$0.2140 in / \$2.5500 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → StreamLake (streamlake/fp8)** — **-48.1%** (ahora \$0.0616 in / \$0.1848 out)
- **glm-5.3-flash** vía **CheaperInference** — **-42.5%** (ahora \$0.0604 in / \$0.2014 out)
- **glm-5.2** vía **OpenRouter** — **-37.9%** (ahora \$0.6000 in / \$2.0000 out)
- **deepseek-v4-flash-0731** vía **CheaperInference** — **-29.8%** (ahora \$0.0322 in / \$0.0645 out)

### Subidas

- **llama-3.1-70b-instruct** vía **OpenRouter** — +80.0% (ahora \$0.7200 in / \$0.7200 out)
- **glm-5.3-flash** vía **OpenRouter → NextBit (nextbit/fp8)** — +18.0% (ahora \$0.1770 in / \$0.5900 out)
- **claude-haiku-4.5** vía **CheaperInference** — +15.1% (ahora \$0.8057 in / \$4.0284 out)

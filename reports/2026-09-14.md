...
> Generado 14/09/2026 15:08 WEST · **598 modelos únicos** · **1002 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **210 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 259 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
3. **hy3** vía **OpenRouter → DeepInfra (deepinfra/fp8)** — calidad 7.0/10 · coste/tarea $0.00576 (\$0.1050 in / \$0.4350 out) · Radar Value 66.3
...
- **qwen3-14b** vía **OpenRouter** — **-73.6%** (ahora \$0.1200 in / \$0.2400 out)
- **qwen3.8-27b** vía **OpenRouter → Phala** — **-26.7%** (ahora \$0.2400 in / \$2.2000 out)
- **nemotron-3-ultra-550b-a55b** vía **OpenRouter** — **-23.2%** (ahora \$0.6000 in / \$2.4000 out)
- **deepseek-v4.1-flash** vía **CheaperInference** — **-13.1%** (ahora \$0.1050 in / \$0.4200 out)

### Subidas

- **deepseek-v4-flash-0731** vía **OpenRouter → Baidu (baidu/fp8)** — +1150.0% (ahora \$0.4400 in / \$1.3200 out)
- **deepseek-v4-flash** vía **OpenRouter** — +74.6% (ahora \$0.0855 in / \$0.1711 out)
- **deepseek-v4-flash** vía **CheaperInference** — +73.6% (ahora \$0.0689 in / \$0.1378 out)
- **deepseek-v4-pro-0813** vía **OpenRouter** — +70.1% (ahora \$0.9834 in / \$2.9502 out)
- **deepseek-v4-flash-0731** vía **OpenRouter** — +50.0% (ahora \$0.0600 in / \$0.1200 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → Relace (relace/fp4)** — +50.0% (ahora \$0.0600 in / \$0.1200 out)
- **hy3** vía **OpenRouter → DeepInfra (deepinfra/fp8)** — +50.0% (ahora \$0.1050 in / \$0.4350 out)
- **deepseek-v4-flash-0731** vía **OpenRouter → OpenInference (open-inference/fp8)** — +42.9% (ahora \$0.0400 in / \$0.1000 out)

...
> Generado 06/09/2026 12:40 WEST · **606 modelos únicos** · **1051 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **236 rutas OpenRouter analizadas** · **376 rutas puntuadas**.
...
| 💻 Coding | LMArena WebDev Arena | **glm-5.3-flash** | **CheaperInference** | $0.00319 | $0.0638 | $0.2125 | 8.2/10 | 79.5 |
...
| **deepseek-v4-pro-0813** | **CheaperInference** | $0.02606 | $0.4988 | $1.4965 | OpenRouter ($0.05854) | **55.5%** |
...
1. **glm-5.3-flash** vía **CheaperInference** — calidad 8.2/10 · coste/tarea $0.00319 (\$0.0638 in / \$0.2125 out) · Radar Value 79.5
...
3. **qwen-3-8-27b** vía **CheaperInference** — calidad 8.0/10 · coste/tarea $0.02142 (\$0.2940 in / \$2.1000 out) · Radar Value 66.9
4. **hy3** vía **OpenRouter → GMICloud (gmicloud/bf16)** — calidad 7.0/10 · coste/tarea $0.00691 (\$0.1260 in / \$0.5220 out) · Radar Value 65.6
...
- **deepseek-v4-flash-0731** vía **OpenRouter** — **-30.9%** (ahora \$0.0500 in / \$0.1000 out)
- **gemini-3.7-flash** vía **CheaperInference** — **-25.5%** (ahora \$0.5250 in / \$2.6250 out)
- **deepseek-v4-pro** vía **OpenRouter** — **-22.8%** (ahora \$0.6876 in / \$1.3753 out)
- **deepseek-v4-pro** vía **OpenRouter → StreamLake (streamlake/fp8)** — **-22.8%** (ahora \$0.6876 in / \$1.3753 out)
- **deepseek-v4-pro** vía **OpenRouter → Baidu (baidu/fp8)** — **-22.6%** (ahora \$0.6963 in / \$1.3926 out)
- **qwen3.8-27b** vía **OpenRouter → Darkbloom (darkbloom/fp4)** — **-21.8%** (ahora \$0.1500 in / \$2.0000 out)
- **deepseek-v4-flash** vía **CheaperInference** — **-14.3%** (ahora \$0.0651 in / \$0.1302 out)
- **gemini-3.1-flash-lite** vía **CheaperInference** — **-14.0%** (ahora \$0.1750 in / \$1.0500 out)
- **deepseek-v4-flash-0731** vía **CheaperInference** — **-11.9%** (ahora \$0.0403 in / \$0.0805 out)
- **aion-labs.aion-2-0** vía **CheaperInference** — **-11.5%** (ahora \$0.7000 in / \$1.4000 out)

### Subidas

- **glm-5.3-flash** vía **OpenRouter → Morph (morph/fp8)** — +300.0% (ahora \$0.3880 in / \$1.3580 out)
- **qwen3.5-35b-a3b** vía **OpenRouter** — +143.1% (ahora \$0.3125 in / \$1.2500 out)
- **gpt-5.6-sol** vía **CheaperInference** — +70.0% (ahora \$1.7000 in / \$8.5000 out)
- **gpt-5.6-terra** vía **CheaperInference** — +46.2% (ahora \$1.7000 in / \$10.2000 out)

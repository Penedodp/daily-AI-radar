...
> Generado 20/09/2026 13:25 WEST · **599 modelos únicos** · **996 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **204 endpoints de 35 modelos OpenRouter monitorizados** · **74 modelos con benchmark**.
...
_Cobertura de benchmark: 74 modelos con benchmark propio, 221 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
- **glm-5.3-flash** vía **OpenRouter → GMICloud (gmicloud/fp8)** — **-28.6%** (ahora \$0.0750 in / \$0.2500 out)
- **kimi-k3** vía **OpenRouter → Morph** — **-21.1%** (ahora \$1.8750 in / \$10.5000 out)
- **muse-glimmer-30b** vía **OpenRouter** — **-20.0%** (ahora \$0.3000 in / \$1.2000 out)
- **deepseek-v4-flash** vía **CheaperInference** — **-18.2%** (ahora \$0.0293 in / \$0.0587 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-17.2%** (ahora \$0.0364 in / \$0.0728 out)
- **deepseek-v4-pro** vía **CheaperInference** — **-10.7%** (ahora \$0.3402 in / \$0.6805 out)

### Subidas

- **ming-image-0.1-design-layer** vía **Novita AI** — +999900.0% (ahora \$1.0000 in / \$1.0000 out)
- **ming-image-0.1-design** vía **Novita AI** — +999900.0% (ahora \$1.0000 in / \$1.0000 out)
- **qwen3.8-27b** vía **OpenRouter** — +96.3% (ahora \$0.4200 in / \$3.0000 out)
- **qwen3.5-35b-a3b** vía **OpenRouter** — +92.3% (ahora \$0.3125 in / \$1.2500 out)
- **gpt-5.6-sol** vía **CheaperInference** — +61.1% (ahora \$1.6114 in / \$8.0569 out)
- **glm-5.2** vía **OpenRouter** — +17.2% (ahora \$0.6496 in / \$2.0416 out)
- **deepseek-v4-pro-0813** vía **OpenRouter** — +14.2% (ahora \$0.6600 in / \$1.9800 out)

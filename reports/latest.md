...
> Generado 05/09/2026 12:16 WEST · **605 modelos únicos** · **1051 rutas/precios** · **4 proveedores de precios** · **2 benchmarks activos** · **237 rutas OpenRouter analizadas** · **376 rutas puntuadas**.
...
- **gpt-5.6-terra** vía **CheaperInference** — **-23.1%** (ahora \$1.1628 in / \$6.9767 out)
- **deepseek-v4-pro** vía **OpenRouter** — **-11.1%** (ahora \$0.8904 in / \$1.7807 out)
...
- **gpt-4.1-nano** vía **CheaperInference** — +10.6% (ahora \$0.0940 in / \$0.3760 out)

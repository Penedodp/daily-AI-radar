...
> **1058 rutas/modelos** útiles · **7 fuentes con datos** · **435 rutas puntuadas**.
...
|---|---|---|---:|---:|---:|---:|
| 💻 Coding | **qwen3.8-max** | OpenRouter | $0.09600 | $2.0000 | $6.0000 | 9.0/10 |
| 🤖 Agentic coding | _Sin benchmark automatizado disponible todavía para esta categoría._ | | | | | |
| 🧠 Razonamiento | _Sin benchmark automatizado disponible todavía para esta categoría._ | | | | | |
| ⚡ General | _Sin benchmark automatizado disponible todavía para esta categoría._ | | | | | |
...
- **qwen3.5-35b-a3b** vía **OpenRouter** — **-53.8%** (ahora \$0.0800 in / \$0.7500 out)
- **deepseek-v4-pro** vía **OpenRouter** — **-48.0%** (ahora \$0.5795 in / \$1.7384 out)
- **qwen3.6-27b** vía **OpenRouter** — **-46.9%** (ahora \$0.3000 in / \$2.0000 out)
- **hy3** vía **OpenRouter** — **-37.5%** (ahora \$0.0825 in / \$0.3300 out)
- **remm-slerp-l2-13b** vía **OpenRouter** — **-17.1%** (ahora \$0.3500 in / \$0.6500 out)
- **deepseek-v4-flash** vía **OpenRouter** — **-14.9%** (ahora \$0.0500 in / \$0.1000 out)

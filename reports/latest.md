...
_Cobertura de benchmark: 73 modelos con benchmark propio, 239 endpoints heredan ese score de su modelo, 0 endpoints benchmarkeados de forma específica (0 es lo esperado hoy — ver Metodología)._
...
5. **minimax-m3** vía **OpenRouter** — calidad 6.7/10 · coste/tarea $0.01620 (\$0.3000 in / \$1.2000 out) · Radar Value 58.2

## 🔥 Bajadas reales de precio (vs ayer)

- **glm-5.2** vía **OpenRouter** — **-59.8%** (ahora \$0.5625 in / \$1.8000 out)
- **kimi-k3** vía **OpenRouter** — **-30.0%** (ahora \$2.1000 in / \$10.9500 out)
- **kimi-k3** vía **CheaperInference** — **-19.4%** (ahora \$1.6919 in / \$8.8223 out)
- **glm-5.3** vía **OpenRouter → Alibaba** — **-15.0%** (ahora \$1.1900 in / \$3.7400 out)
- **glm-5.3-flash** vía **OpenRouter → NextBit (nextbit/fp8)** — **-11.1%** (ahora \$0.1800 in / \$0.6000 out)
- **qwen3.8-27b** vía **OpenRouter → Mancer 2 (mancer/fp8)** — **-11.1%** (ahora \$0.2000 in / \$2.5000 out)

### Subidas

- **gpt-oss-120b** vía **OpenRouter** — +305.4% (ahora \$0.1500 in / \$0.6000 out)
- **deepseek-v4-flash** vía **OpenRouter** — +86.0% (ahora \$0.0558 in / \$0.1767 out)
- **qwen3-6-35b-a3b** vía **CheaperInference** — +40.0% (ahora \$0.0980 in / \$0.7000 out)
- **deepseek-chat** vía **OpenRouter** — +24.3% (ahora \$0.3200 in / \$0.8900 out)
- **muse-spark-1.2** vía **CheaperInference** — +21.4% (ahora \$1.0625 in / \$3.6125 out)
- **glm-5.3** vía **OpenRouter → Morph (morph/fp8)** — +16.5% (ahora \$1.1781 in / \$3.7026 out)

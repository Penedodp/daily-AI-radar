# AI Price Radar — 2026-09-02

> **412 rutas/modelos** útiles · **1 fuentes con datos** · **69 rutas puntuadas**.
...
- **deepseek-chat-v3.1** vía **OpenRouter** — **-49.9%**
- **deepseek-v4-pro** vía **OpenRouter** — **-34.9%**
- **glm-5.2** vía **OpenRouter** — **-18.8%**
- **qwen3.8-2.4t-a95b:batch** vía **OpenRouter** — **-14.6%**

### Subidas

- **deepseek-v4-pro** vía **OpenRouter** — +69.0%
- **nemotron-3-ultra** vía **OpenRouter** — +33.1%
